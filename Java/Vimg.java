 ...
 *
 */
public class Vimg extends HttpServlet {
      ...
      public void doPost(HttpServletRequest request, HttpServletResponse response)
		   ...
		   String strQuery= ""; 
			...
			conn = DriverManager.getConnection(url+dbName,userName,password);
					...
					user = request.getParameter("password").toString();
					pass = request.getParameter("password1").toString();
                                        p1 = request.getParameter("password2").toString();
                                      ...
                                      // request.setAttribute("uname",us);
                                        ...
                                        if(ipsd.equals(pw) ){
                                            ...
                                            //System.out.println("ret-forward");		 
                                             ...
                                             out.println("<script>alert('Graphical Incorrect Password'); "
